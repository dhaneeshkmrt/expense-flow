...
export const GEMINI_MODELS: AIModelOption[] = [
  ...
  { value: 'gemini-3.6-flash', label: 'Gemini 3.6 Flash', description: 'Next-gen fast model', isNew: true },
  ...
  { value: 'gemini-2.5-flash', label: 'Gemini 2.5 Flash', description: 'Latest multimodal flash model' },
  { value: 'gemini-2.5-pro', label: 'Gemini 2.5 Pro', description: 'High capability deep reasoning' },
  { value: 'gemini-2.0-flash', label: 'Gemini 2.0 Flash', description: 'Fast, stable & recommended' },
